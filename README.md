# Android Template <img src="https://android-developers.googleblog.com/favicon.ico" height=23/>

This is an opinionated template for new Android projects.
...
### `localization` module
Localization module is meant to be used in the `app` module to provide translations for the `app` and `designsystem` module to provide translations for the design system components (such as accessibility labels). 
...
- **Dev**: Intended for developers use only. This has LeakCanary to help detect leaks.
- **Production**: Intended for release. This version usually has live endpoint and signed builds.
